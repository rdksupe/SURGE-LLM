...
def call_llm_api(csv_path, personality=""):
...
Please respond only with a JSON object with your answer as the letter choice, like {"answer": "A"}"""
    ...
    for idx, row in df.iterrows():
        ...
        try:
            system_message = "You are answering a personality test honestly. Respond with just the JSON object containing your answer."
            if personality:
                system_message = f"{personality} {system_message}"
